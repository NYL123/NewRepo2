...
public class TestExternalSplashCoordinatorServiceImpl {

    @InjectMocks
    private ExternalSplashCoordinatorServiceImpl externalSplashCoordinatorServiceImpl;
    ...
    public void setUp() throws Exception {
        externalSplashCoordinatorServiceImpl = new ExternalSplashCoordinatorServiceImpl();
        ...
        PowerMockito.when(valueMap.get(HertzConstants.JCR_CQ_TEMPLATE))
                .thenReturn("location");
        servclass = externalSplashCoordinatorServiceImpl.getClass();
        fields = servclass.getDeclaredFields();
        PrivateAccessor.setField(externalSplashCoordinatorServiceImpl,
    ...
    public void testActivate() throws NoSuchMethodException, SecurityException,
        ...
        Method activate = externalSplashCoordinatorServiceImpl.getClass()
                .getDeclaredMethod("activate", ComponentContext.class);
        activate.setAccessible(true);
        activate.invoke(externalSplashCoordinatorServiceImpl,
    ...
    public void testGetCollatedData()
        ...
        CoordinatorConsumable consumable = externalSplashCoordinatorServiceImpl
    ...
    public void testgetSpecificDataPath() {
        String[] mappingsDataCoord = new String[] {
                "/rates-config/default-rq-code:rqcodes", "/locations:location",
                "/errormessages-config:errormessages" };
        String path = externalSplashCoordinatorServiceImpl.getSpecificDataPath(
        ...
        mappingsDataCoord = new String[] { "/rates-config/default-rq-code:",
                "/locations:" };
        path = externalSplashCoordinatorServiceImpl.getSpecificDataPath(
                TestConstants.LOCATION_PATH, TestConstants.CONTENT_DATA_PATH,
                mappingsDataCoord);
        Assert.assertNotNull(path);
    }
    ...
    public void testformRequestParams()
        ...
        externalSplashCoordinatorServiceImpl
