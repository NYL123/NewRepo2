...
public class HertzDispatcherFlushRulesImplTest {
    @Mock
   ...
   /* @Mock
    ...
    @InjectMocks
    private HertzDispatcherFlushRulesImpl dispatcherFlushRules = new HertzDispatcherFlushRulesImpl();

    @Before
    public void setUp() throws Exception {
        MockitoAnnotations.initMocks(this);
//        when(systemService.getServiceResourceResolver()).thenReturn(mock(ResourceResolver.class));
        when(rFactory.getAdministrativeResourceResolver(null)).thenReturn(mock(ResourceResolver.class));
    }

    @After
    public void tearDown() throws Exception {
        reset(dispatcherFlusher, rFactory, hierarchicalFlushRules, resourceOnlyFlushRules);
    }
    ...
    public void testPreprocess_notAccepts_ReplicationActionNoFlushRules() throws Exception {
        ...
        when(replicationAction.getPath()).thenReturn("/content/site");
    ...
    public void testPreprocess_success_hierarchical() throws Exception {
        hierarchicalFlushRules.put(Pattern.compile("/content/site/.*"), new String[] { "/content/target", "/content/target2" });

        final ReplicationAction replicationAction = mock(ReplicationAction.class);
        when(replicationAction.getPath()).thenReturn("/content/site/page");
        when(replicationAction.getType()).thenReturn(ReplicationActionType.ACTIVATE);

        final ReplicationOptions replicationOptions = new ReplicationOptions();
        replicationOptions.setSynchronous(false);

        final ArgumentCaptor<HertzDispatcherFlushFilter> agentFilterCaptor = ArgumentCaptor.forClass(HertzDispatcherFlushFilter
                .class);
        ...
        assertEquals(HertzDispatcherFlushFilter.HertzFlushType.Hierarchical, agentFilterCaptor.getValue().getFlushType());
    ...
    public void testPreprocess_success_resourceOnly() throws Exception {
        resourceOnlyFlushRules.put(Pattern.compile("/content/site/.*"), new String[] { "/content/target" });
    ...
    public void testPreprocess_success_hierarchicalAndResourceOnly() throws Exception {
        ...
        final ReplicationOptions replicationOptions = new ReplicationOptions();
        replicationOptions.setSynchronous(false);
        replicationOptions.setFilter(new HertzDispatcherFlushFilter());
    ...
    public void testPreprocess_success_translation1() throws Exception {
        hierarchicalFlushRules.put(Pattern.compile("/content/site/(.*)"), new String[] { "/content/target/$1" });
    ...
    public void testPreprocess_success_translation2() throws Exception {
        hierarchicalFlushRules.put(Pattern.compile("/content/site/(.*)/(.*)"), new String[] { "/content/target/$1/site/$2" });

        final ReplicationAction replicationAction = mock(ReplicationAction.class);
        when(replicationAction.getPath()).thenReturn("/content/site/en/page");
        when(replicationAction.getType()).thenReturn(ReplicationActionType.ACTIVATE);
        ...
        verify(dispatcherFlusher, times(1)).flush(any(ResourceResolver.class), eq(ReplicationActionType.ACTIVATE),
                eq(false),
                agentFilterCaptor.capture(),
                eq("/content/target/en/site/page"));
    ...
    public void testPreprocess_success_resourceonly_translation2() throws Exception {
        resourceOnlyFlushRules.put(Pattern.compile("/content/site/(.*)/(.*)"), new String[] { "/content/target/$1/site/$2" });
