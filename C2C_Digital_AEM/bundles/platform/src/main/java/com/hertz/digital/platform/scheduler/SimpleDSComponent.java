...
public class SimpleDSComponent implements Runnable {
    ...
    protected void activate(ComponentContext ctx) {
      ...
      //case 3: with fireJobAt(): executes the job at a specific date (date of deployment + delay of 30 seconds)
        ...
        String schedulingExpression = "0 0/5 12 ? * MON-FRI"; //10:15am every Monday, Tuesday, Wednesday, Thursday and Friday
        ...
        final Runnable job = new Runnable() {
            public void run() {
            	...
            	System.out.println("Sling schedular is working successfully." + System.currentTimeMillis());
