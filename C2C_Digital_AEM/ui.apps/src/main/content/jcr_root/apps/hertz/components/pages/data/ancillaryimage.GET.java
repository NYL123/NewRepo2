...
public class ancillaryimage_GET extends AbstractImageServlet {

	/**
	 * ancillaryimage.GET.java
	 */
	private static final long serialVersionUID = 196913257631905531L;

	private static final Logger LOGGER = LoggerFactory.getLogger(ancillaryimage_GET.class);
